...
A tutorial is available [here](http://rferrali.github.io/banditr). It is also available as a vignette in the package. To access the vignette, make sure to compile it as you install the package, and use: 
